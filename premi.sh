...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO JMS STORE VPN ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}HOKAGE LEGEND® ${NC}${YELLOW}(${NC}${green}V 3.2${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅟🅝: JMS VPN STORE ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/scisaa/AutoSc/main/"
...
clear
izinsc="https://raw.githubusercontent.com/scisaa/ijin/main/ipvps"
# USERNAME
rm -f /usr/bin/user
...
TIMES="10"
CHATID="1846890724"
KEY="7616921030:AAF-HowFYSsAbcPY1UYaLUc2ugJ87_nuaAI"
...
wget -q https://raw.githubusercontent.com/scisaa/AutoSc/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
wget -q -O /etc/default/dropbear https://raw.githubusercontent.com/scisaa/beta/main/config/dropbear.conf
...
wget -q https://raw.githubusercontent.com/scisaa/AutoSc/main/udp-custom/udp-custom.sh
...
# Ganti Banner
wget -O /etc/hokage.txt https://raw.githubusercontent.com/scisaa/beta/main/files/issue.net
